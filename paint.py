...
class PaintWindow(wx.Window): 
    ...
    def bindMenuEvents(self, menuHandler, updateUIHandler, ids): 
        ...
        for event, handler in [(wx.EVT_MENU_RANGE, menuHandler),(wx.EVT_UPDATE_UI_RANGE, updateUIHandler)]:                                   
...
class PaintFrame(wx.Frame): 
    def __init__(self, parent=None): 
        super(PaintFrame, self).__init__(parent, title="Paint - Version 1.0 - QuantumPhysics", 
            size=(800,600), 
